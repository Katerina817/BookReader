Цель проекта: Приложение «Читательский дневник», предназначенное для ведения личного учёта прочитанных книг, фиксации статуса чтения и создания заметок, а также социального взаимодействия пользователей: добавление друзей и просмотр их читательской активности.
